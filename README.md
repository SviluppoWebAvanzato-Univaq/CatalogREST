# JAXRS_Example_Catalog
> Example RESTful API "Catalog" developed with JAX-RS (Jersey) on JakartaEE10 and Tomcat 11
 
This is the full implementation of the "Catalog" RESTful API developed during the course lectures. It shows how to model the service using JAX-RS, including sub-resources, bearer token authorization and CORS headers injection.
